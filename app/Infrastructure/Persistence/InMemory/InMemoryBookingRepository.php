...
final class InMemoryBookingRepository implements BookingRepositoryInterface
{
    ...
    public function __construct()
    {
        ...
        $seed = [
            ...
            // Sala Aroeira — 09:00–10:30
            ['b0000003-0001-0001-0001-000000000001', 'a1b2c3d4-0003-0003-0003-000000000003', $today, 540,  90,  'g.xavier',     $now],
            // Sala Aroeira — 13:00–14:00
            ['b0000003-0002-0002-0002-000000000002', 'a1b2c3d4-0003-0003-0003-000000000003', $today, 780,  60,  'r.santos',     $now],
            // Sala Cedro — 08:30–09:30
            ['b0000004-0001-0001-0001-000000000001', 'a1b2c3d4-0004-0004-0004-000000000004', $today, 510,  60,  'p.oliveira',   $now],
            // Sala Cedro — 11:00–12:00
            ['b0000004-0002-0002-0002-000000000002', 'a1b2c3d4-0004-0004-0004-000000000004', $today, 660,  60,  'j.ferreira',   $now],
            // Sala Cedro — 16:00–17:00
            ['b0000004-0003-0003-0003-000000000003', 'a1b2c3d4-0004-0004-0004-000000000004', $today, 960,  60,  'time.produto', $now],
        ];
